...
export const PREVIEW_DOMAIN_CONFIGS: Record<ClinicalDomainId, PreviewDomainConfig> = {
  ...
  alc: {
    ...
    metricByCode: {
      ...
      ALCRISKATRISK: { label: 'Alcohol Use', value: '16 Units', badge: 'AMBER', badgeClass: 'amber', pathway: 'Your alcohol intake is above recommended levels. Try to have at least 3 alcohol-free days per week.' },
      ALCRISKTOOMUCH: { label: 'Alcohol Use', value: '20 Units', badge: 'HIGH RISK', badgeClass: 'red', pathway: 'Your alcohol intake is high and affecting your health. Support is available to help you cut down.' },
      ALCRISKTOOMUCH1: { label: 'Alcohol Use', value: '20 Units', badge: 'HIGH RISK', badgeClass: 'red', pathway: 'Your alcohol intake is high and affecting your health. Support is available to help you cut down.' },
