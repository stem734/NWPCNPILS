...
export const PREVIEW_DOMAIN_CONFIGS: Record<ClinicalDomainId, PreviewDomainConfig> = {
  ...
  alc: {
    ...
    metricByCode: {
      ALCRISKTEETOTAL: { label: 'Alcohol Use', value: 'Teetotal', badge: 'HIGH RISK', badgeClass: 'red', pathway: 'This alcohol code is treated as higher risk in the configured order and should be reviewed by the clinical team.' },
      ALCRISKOK: { label: 'Alcohol Use', value: '8 Units', badge: 'HIGH RISK', badgeClass: 'red', pathway: 'This alcohol code is treated as higher risk in the configured order and should be reviewed by the clinical team.' },
      ALCRISKTOOMUCH: { label: 'Alcohol Use', value: '20 Units', badge: 'REVIEW', badgeClass: 'amber', pathway: 'This alcohol code is treated as medium risk in the configured order and should be reviewed with the patient.' },
      ALCRISKTOOMUCH1: { label: 'Alcohol Use', value: '20 Units', badge: 'REVIEW', badgeClass: 'amber', pathway: 'This alcohol code is treated as medium risk in the configured order and should be reviewed with the patient.' },
      ALCRISKATRISK: { label: 'Alcohol Use', value: '16 Units', badge: 'LOW RISK', badgeClass: 'ok', pathway: 'This alcohol code is treated as lower risk in the configured order.' },
    },
